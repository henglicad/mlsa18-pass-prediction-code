...
% define a command for specialcell
...
%150--250 words.
\input{tex-camera-ready/abstract}
...
\input{tex-camera-ready/introduction}

\input{tex-camera-ready/dataexploration}

\input{tex-camera-ready/methodology}

\input{tex-camera-ready/results}

\input{tex-camera-ready/conclusions}
