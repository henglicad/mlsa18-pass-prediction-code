...
\hypobox{
Our models can predict the target of a pass with a top-1, top-3 and top-5 accuracy of 49\%, 83\%, and 94\%, respectively, when we exclude false passes. Our models perform better when the sender of a pass is in the back or front area of the field.
}