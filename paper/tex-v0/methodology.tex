...
A good model should rank the correct receiver among the top of the ranked list.
\textbf{LambdaMART}~\cite{burges2010ranknet} which is the gradient boosted tree version of LambdaRank is widely used for learning to rank tasks.
There are quite a few effective implementations of LambdaMART, such as XGBoost and pGBRT, which usually achieves state-of-the-art performance in learning to rank tasks.
