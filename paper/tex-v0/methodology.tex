...
\textbf{LambdaMART}~\cite{burges2010ranknet} is the boosted tree version of LambdaRank. It relies on a Gradient Boosting Decision Tree (GBDT)~\cite{friedman2001greedy} to provide ranking predictions.
