...
Among the top 10 important features, there are eight features from the dimension of candidate receiver position. %, one from the sender position dimension, and one from the passing path dimension.
